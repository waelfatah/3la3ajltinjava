...
public class Session {
 ...
 private static int idCommande;
         private static ObservableList<Formation> panier=FXCollections.observableArrayList();
    ...
    public static ObservableList<Formation> getPanier() {
        return panier;
    }
    ...
    /*public static Commande getCommande(int id){
     ...
     public static Formulaire_Inscription getReservation(int id){
        Formulaire_Inscription comm = null;
        ReservationService cs = new ReservationService();
        comm=cs.afficherUserReservation(id);
        return comm;
    }
}
