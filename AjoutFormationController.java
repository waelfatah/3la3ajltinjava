    ...
    private void AddProduit(ActionEvent event) {
        ...
        if (!Ps.NomControle(titre.getText())) {
            ...
            if (Ps.NomControle(titre.getText()) && dateDébut.getValue() !=null && dateFin.getValue()!=null&&(Ps.descriptionControle(description.getText()))
                ...
                Formation E = new Formation(titre.getText(),Date.valueOf(dateDébut.getValue()),Date.valueOf(dateFin.getValue()), Integer.valueOf(capacité.getText()), adresse.getText(),description.getText(),image.getText());

                Ps.ajouterFormation(E);
                try {
                    ...
                    trayIcon.displayMessage("Formation, ".concat(titre.getText()), "Ajouté avec succès !!", TrayIcon.MessageType.INFO);
                    // Error:
