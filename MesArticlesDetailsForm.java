...
public class MesArticlesDetailsForm extends Form {

    final Resources res;
    static Article ArticleS;
    private Article article;

    public MesArticlesDetailsForm() {
       ...
       Label conf = new Label("Etat : "+article.getEtat());
       ...
       btnModifier.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                EditArticleForm.articleS=article;
                Form bdf = new EditArticleForm();
                bdf.show();
            }
        }); 
       
       Button btnSupp = new Button("Supprimer Article");
        center.addComponent(btnSupp);
       btnSupp.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                ServiceArticle SA = new ServiceArticle();
                SA.DeleteArticle(article.getIdArticle());
        ...
        this.addComponent(BorderLayout.CENTER, center);
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Form bdfa = new MesArticlesForm(res);
                    bdfa.show();
            }
        });
